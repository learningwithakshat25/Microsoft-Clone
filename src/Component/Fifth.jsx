...
const Fifth = () => {
  return (
    <div className='container mx-auto w-screen flex flex-col p-4  gap-4 shadow-lg rounded-md md:flex-row'>
        <div className="fifth1 flex flex-col gap-4 md:w-1/4 shadow-md p-2 md:relative ">
        <img className='w-screen' src={Img1} alt="img" />
        <h1 className='font-semibold text-2xl '>Xbox Series X</h1>
        <p>The fastest most Shop Shop Xbox Series X</p>
        <button className='w-fit p-2 bg-blue-700 text-white md:absolute bottom-5'>Shop Xbox Series X</button>
        </div>
        <div className="fifth2 flex flex-col gap-4 md:w-1/4 shadow-md p-2 md:relative">
        <img className='w-screen' src={Img2} alt="img" />
        <h1 className='font-semibold text-2xl '>Xbox Series S</h1>
        <p>Next-gen performance in the smallest Xbox ever.</p>
        <button className='w-fit p-2 bg-blue-700 text-white md:absolute bottom-5'>Join Now</button>
        </div>
        <div className="fifth3 flex flex-col gap-4 md:w-1/4 shadow-md p-2 md:relative">
        <img className='w-screen' src={Img3} alt="img" />
        ...
        <div className="fifth4 flex flex-col gap-4 md:w-1/4 shadow-md p-2">
        <img className='w-screen' src={Img4} alt="img" />
